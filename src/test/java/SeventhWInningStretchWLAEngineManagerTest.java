...
public class SeventhWInningStretchWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SeventhWInningStretchWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/7thWInningStretchWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/7thWInningStretchWLAIW/InitOutcome.xml").getDocumentElement();
